...
function Shell({data,refresh,notify}) {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open?"open":""}`}>
      <div className="side-brand"><div className="brand-mark small"><img src="/icons/pulsar-192.png" alt="Pulsar" width={20} className="brand-icon" /></div><div><b>Pulsar</b><span>Admin panel</span></div><button className="mobile-close icon-btn" onClick={()=>setOpen(false)}><X size={18}/></button></div>
